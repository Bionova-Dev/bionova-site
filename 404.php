...
<main class="site-main pt-[142px] pb-16 bg-white min-h-screen">
    <div class="max-w-3xl mx-auto px-6 text-center py-20">
        <p class="text-9xl font-black text-[#e4002b]/10 font-display mb-8">404</p>
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="inline-block px-10 py-5 bg-[#e4002b] text-white font-bold rounded-2xl shadow-xl hover:bg-gray-900 transition-all hover:-translate-y-1">
