      ...
      return (
        <div className="animate-fade-in">
          ...
          {(() => {
            const slides = [
              {
                image: "https://images.unsplash.com/photo-1536064479547-7ee40b74b807?auto=format&fit=crop&w=1920&q=80",
              ...
              },
              {
                ...
                badge: "Formules Certifiées",
                title1: "La précision",
                title2: "du laboratoire",
                titleColor: "text-emerald-300",
                subtitle: "Chaque formule Bionova naît d'une recherche scientifique rigoureuse. Nos actifs sont sélectionnés pour leur pureté clinique et leur biodisponibilité maximale.",
              ...
              },
              {
                ...
                badge: "Bien-être au quotidien",
                title1: "Retrouvez votre",
                title2: "équilibre naturel",
                titleColor: "text-amber-200",
                subtitle: "Chaque jour est une nouvelle opportunité de prendre soin de vous. Nos compléments vous accompagnent vers un équilibre durable, corps et esprit.",
                cta1: { label: "Commencer ma cure", page: "products" },
                cta2: { label: "Nos Conseils", page: "blog" },
              },
              {
                image: "https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&w=1920&q=80",
                badge: "Livraison Express Tunisie",
                title1: "Frais, pur et livré",
                title2: "en 24 heures",
                titleColor: "text-pink-200",
                subtitle: "Vos compléments sont préparés avec soin et expédiés sous 24h. Livraison gratuite dès 150 DT partout en Tunisie, dans un emballage isotherme préservant leur efficacité.",
                cta1: { label: "Commander maintenant", page: "products" },
