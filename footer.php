...
?>
  ...
  <div class="bg-white border-t border-b border-gray-100 relative z-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 py-8 sm:py-12">
  ...
  <!-- Footer — Light Theme -->
  <footer class="bg-[#f1f5f9] pt-24 pb-12 mt-auto border-t border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12 mb-12 lg:mb-20">
        <div class="flex flex-col items-center md:items-start">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/brand/logo-bionova.webp" alt="Bionova Logo" class="h-12 lg:h-16 object-contain mb-8" loading="lazy" decoding="async" width="200" height="80" />
        ...
        <div class="text-center md:text-left">
          ...
          <ul class="space-y-4">
            <li><a href="<?php echo get_permalink( get_page_by_path( 'boutique' ) ); ?>" class="text-gray-600 hover:text-[#e4002b] transition-colors font-bold text-sm">Tous les produits</a></li>
            <li><a href="<?php echo get_permalink( get_page_by_path( 'boutique' ) ); ?>" class="text-gray-600 hover:text-[#e4002b] transition-colors font-bold text-sm">Packs Synergie</a></li>
            <li><a href="<?php echo get_permalink( get_page_by_path( 'astuces' ) ); ?>" class="text-gray-600 hover:text-[#e4002b] transition-colors font-bold text-sm">Astuces Santé</a></li>
            <li><a href="<?php echo get_permalink( get_page_by_path( 'expertise' ) ); ?>" class="text-gray-600 hover:text-[#e4002b] transition-colors font-bold text-sm">Notre Expertise</a></li>
          </ul>
        </div>
        <div class="text-center md:text-left">
          ...
          <ul class="space-y-4">
            <li class="flex items-center justify-center md:justify-start text-gray-600 font-bold text-sm">
              <svg class="w-5 h-5 mr-3 text-[#e4002b] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              contact@bionova.tn
            </li>
            <li class="flex items-center justify-center md:justify-start text-gray-600 font-bold text-sm">
              <svg class="w-5 h-5 mr-3 text-[#e4002b] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
              +216 71 000 000
            </li>
          </ul>
        </div>
        <div class="text-center md:text-right">
          ...
          <div class="flex justify-center md:justify-end space-x-4 mb-8">
            <a href="https://www.instagram.com/bionova" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-[#e4002b] hover:text-white transition-all" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/bionova" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-[#e4002b] hover:text-white transition-all" aria-label="Facebook">
          ...
          <div class="flex flex-col space-y-2 items-center md:items-end">
            <a href="javascript:void(0)" class="text-[10px] font-black text-gray-500 hover:text-[#e4002b] transition-colors uppercase tracking-widest">Mentions Légales &amp; CGV</a>
            <a href="javascript:void(0)" class="text-[10px] font-black text-gray-500 hover:text-[#e4002b] transition-colors uppercase tracking-widest">Politique de confidentialité</a>
          </div>
        </div>
      </div>
