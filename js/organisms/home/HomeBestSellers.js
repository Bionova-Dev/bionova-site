    ...
    <section className="py-28 bg-white relative border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-20">
          <a href={BIONOVA_ROUTES.products} className="px-12 py-5 bg-[#be123c] text-white font-bold rounded-2xl hover:bg-gray-900 transition-all shadow-xl hover:-translate-y-1 cursor-pointer">Voir toute la boutique &rarr;</a>
        </div>
      </div>
    </section>
  );
