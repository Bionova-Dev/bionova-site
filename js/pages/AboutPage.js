  ...
  <div className="bg-white min-h-screen">
    ...
    <section className="relative pt-36 pb-32 overflow-hidden bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          <h1 className="font-display text-3xl sm:text-5xl lg:text-7xl font-black mb-8 leading-tight">L'excellence au service de la cellule.</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
          {[
            ...
            { icon: LeafIcon, title: "Ingrédients Naturels", desc: "Des formules à base d'ingrédients d'origine naturelle, soigneusement sélectionnés pour leur pureté et leur efficacité." },
    ...
    <section className="py-24 bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        {onNavigate && (
          <button onClick={() => onNavigate('products')} className="px-8 py-4 text-base sm:px-12 sm:py-5 sm:text-lg lg:px-16 lg:py-6 lg:text-xl bg-bionova-red text-white font-black rounded-3xl shadow-2xl hover:bg-white hover:text-gray-900 transition-all transform hover:-translate-y-1 cursor-pointer">Explorer la boutique</button>
        )}
      </div>
    </section>
  </div>
