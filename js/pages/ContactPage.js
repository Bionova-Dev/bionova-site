          ...
          <div className="bg-white p-10 sm:p-14 rounded-[3rem] shadow-xl border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="contact-name" className="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-3">Nom complet</label>
                  <input id="contact-name" type="text" required className="py-4 px-6 block w-full bg-gray-50 border border-transparent focus:bg-white focus:border-medical-blue focus:ring-2 focus:ring-medical-blue/20 rounded-2xl text-gray-900 transition-all outline-none" placeholder="Jean Dupont" />
                </div>
                <div>
                  <label htmlFor="contact-email" className="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-3">Email</label>
                  <input id="contact-email" type="email" required className="py-4 px-6 block w-full bg-gray-50 border border-transparent focus:bg-white focus:border-medical-blue focus:ring-2 focus:ring-medical-blue/20 rounded-2xl text-gray-900 transition-all outline-none" placeholder="jean@exemple.com" />
                </div>
              </div>
              <div>
                <label htmlFor="contact-subject" className="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-3">Sujet</label>
                <select id="contact-subject" required className="py-4 px-6 block w-full bg-gray-50 border border-transparent focus:bg-white focus:border-medical-blue focus:ring-2 focus:ring-medical-blue/20 rounded-2xl text-gray-900 transition-all outline-none appearance-none cursor-pointer">
              ...
              <div>
                <label htmlFor="contact-message" className="block text-xs font-bold text-gray-700 uppercase tracking-widest mb-3">Message</label>
                <textarea id="contact-message" rows="5" required className="py-4 px-6 block w-full bg-gray-50 border border-transparent focus:bg-white focus:border-medical-blue focus:ring-2 focus:ring-medical-blue/20 rounded-2xl text-gray-900 transition-all outline-none resize-none" placeholder="Votre message..."></textarea>
              </div>
              <button type="submit" className="w-full py-5 px-8 shadow-lg text-lg font-bold rounded-2xl text-white bg-bionova-red hover:bg-gray-900 transition-all transform hover:-translate-y-1 cursor-pointer">Envoyer le message</button>
            </form>
          </div>
