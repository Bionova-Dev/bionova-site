          ...
          <div className="flex flex-col h-full justify-center lg:py-10">
            ...
            <div className="mb-8 bg-gray-50 border border-gray-200 rounded-3xl p-6 sm:p-8 shadow-sm">
              ...
              <button 
                ...
                className="w-full mt-6 py-4.5 px-6 font-bold uppercase tracking-widest rounded-2xl text-[10px] text-white bg-gray-900 hover:bg-bionova-red transition-all cursor-pointer shadow-md text-center"
              >
              ...
              <div className="max-w-3xl mx-auto bg-white border border-gray-100 rounded-3xl p-8 sm:p-10 shadow-md mb-16">
                ...
                {successMessage ? (
                  ...
                  <form onSubmit={(e) => {
                    ...
                    <button 
                      type="submit"
                      className="w-full py-4 font-bold uppercase tracking-wider rounded-2xl text-sm text-white bg-[#be123c] hover:bg-gray-900 transition-all cursor-pointer shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 duration-300"
                    >
                      Publier mon avis
                    </button>
                  </form>
