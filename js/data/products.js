...
const products = [
  {
    id: 1, name: "Acide Alpha Lipoïque", description: "L'antioxydant universel par excellence. Agit aussi bien en milieu aqueux que lipidique pour une protection cellulaire totale.", price: 45.00, image: THEME_URI + "/assets/products/acide-alpha-lipoique.png",
  ...
  {
    id: 2, name: "Ashwagandha", description: "Plante adaptogène majeure de l'Ayurvéda. Aide l'organisme à résister au stress et favorise l'équilibre émotionnel.", price: 38.50, image: THEME_URI + "/assets/products/ashwagandha.png",
  ...
  {
    id: 3, name: "Astaxanthine", description: "L'antioxydant le plus puissant du monde marin. Protège efficacement contre le vieillissement cellulaire et les UV.", price: 65.00, image: THEME_URI + "/assets/products/astaxanthine.png",
  ...
  {
    id: 4, name: "Biotine", description: "Vitamine B8 hautement dosée. Indispensable pour la beauté des cheveux, des ongles et l'éclat de la peau.", price: 29.90, image: THEME_URI + "/assets/products/biotine.png",
  ...
  {
    id: 5, name: "Collagène Marin Complex", description: "Peptides de collagène brevetés associés à l'acide hyaluronique pour une régénération profonde des tissus.", price: 32.00, image: THEME_URI + "/assets/products/collagene-marin.png",
  ...
  {
    id: 6, name: "Curcumine et Boswellia", description: "Synergie anti-inflammatoire naturelle puissante pour le confort articulaire et digestif.", price: 25.00, image: THEME_URI + "/assets/products/curcumine-boswellia.png",
  ...
  {
    id: 7, name: "L-Carnosine", description: "Di-peptide d'exception contre la glycation des protéines. Un pilier de la stratégie anti-âge cellulaire.", price: 28.50, image: THEME_URI + "/assets/products/lcarnosine.png",
  ...
  {
    id: 8, name: "Lion's Mane", description: "Champignon nootropique réputé pour stimuler la concentration, la mémoire et la régénération neuronale.", price: 55.00, image: THEME_URI + "/assets/products/lion-mane.png",
  ...
  {
    id: 9, name: "Neem", description: "Purifiant ancestral de la peau et du sang. Utilisé en Ayurvéda pour ses propriétés détoxifiantes.", price: 42.00, image: THEME_URI + "/assets/products/neem.png",
  ...
  {
    id: 10, name: "NMN", description: "Le précurseur ultime du NAD+. Une avancée scientifique majeure pour l'énergie cellulaire et la réparation de l'ADN.", price: 22.50, image: THEME_URI + "/assets/products/nmn.png",
