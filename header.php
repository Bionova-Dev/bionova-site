    ...
    <div class="max-w-7xl mx-auto px-6 w-full flex justify-between items-center">
      ...
      <div class="flex items-center space-x-4">
        ...
        wp_nav_menu( array(
            ...
            'container'      => 'nav',
            'container_class'=> 'hidden md:flex items-center space-x-6',
            'menu_class'     => 'menu flex items-center space-x-6 list-none m-0 p-0',
            'fallback_cb'    => false
        ) ); 
        ?>
        ...
        <!-- Icône Panier -->
        <a href="<?php echo function_exists('wc_get_cart_url') ? esc_url( wc_get_cart_url() ) : '/panier/'; ?>" class="relative p-3 rounded-2xl bg-gray-900 text-white hover:bg-medical-blue transition-all shadow-lg" title="Voir le panier">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
