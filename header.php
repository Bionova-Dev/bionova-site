      ...
      <nav class="max-w-[1800px] mx-auto px-4 lg:px-12 w-full h-full" aria-label="Navigation principale">
        <div class="flex justify-between items-center h-full gap-4 lg:gap-8">
          ...
          <div class="hidden lg:flex flex-grow justify-center items-center space-x-12">
            ...
            <a href="<?php echo home_url('/#about'); ?>" class="text-sm lg:text-[20px] font-black uppercase tracking-[0.15em] transition-all duration-300 cursor-pointer py-2 px-1 border-b-4 text-black border-transparent hover:text-[#be123c] hover:border-[#be123c]" style="font-family: 'Montserrat', sans-serif;">Expertise</a>
            <a href="<?php echo home_url('/#contact'); ?>" class="text-sm lg:text-[20px] font-black uppercase tracking-[0.15em] transition-all duration-300 cursor-pointer py-2 px-1 border-b-4 text-black border-transparent hover:text-[#be123c] hover:border-[#be123c]" style="font-family: 'Montserrat', sans-serif;">Contact</a>
          </div>
