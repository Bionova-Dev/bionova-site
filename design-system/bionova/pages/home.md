...
─────────────────────────────────────────
Contact CTA (bg-gray-900, gradient #e4002b/20)
─────────────────────────────────────────
Trust Bar + Footer
```
...
- **Best Sellers :** Badge "Best Seller" `bg-[#e4002b]`, prix en rouge, bouton panier `bg-gray-900 hover:bg-bionova-red`
- **Packs :** `gold-border`, images superposées avec rotation au hover, prix barré + prix pack en rouge
- **Témoignages :** Guillemets décoratifs `text-[#e4002b]/10`, étoiles jaunes
