...
| Élément | Style |
|---------|-------|
| Prix | `font-family: Montserrat, font-weight: 800, color: #be123c` |
| Bouton Checkout | `bg-[#be123c], rounded-[1.25rem], uppercase, tracking-[0.15em]` |
...
| Badges (.onsale) | `bg-[#be123c], text-white, font-weight: 900` |
