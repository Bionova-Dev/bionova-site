...
Articles Grid (3 cols desktop, 1 mobile, gap-8)
  └── Article Card × N
      ...
      ├── Category badge (bg-[#be123c], absolute top-4 left-4)
      ├── Title (font-bold, hover:text-[#be123c])
...
- **Category badge :** `bg-[#be123c] text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest`
- **Title hover :** `group-hover:text-[#be123c] transition-colors`
